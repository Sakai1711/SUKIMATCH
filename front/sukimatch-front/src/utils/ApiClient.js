...
function createAxiosInstance() {
  ...
  axiosInstance.interceptors.request.use((request) => {
    ...
    if (sessionStorage.getItem('access_token')) {
      request.headers['access_token'] = sessionStorage.getItem('access_token')
    } else {
      // location.href
    }
    //request.headers['access_token'] = `eyJhbGciOiJSUzI1NiIsImtpZCI6IjFlNjYzOGY4NDlkODVhNWVkMGQ1M2NkNDI1MzE0Y2Q1MGYwYjY1YWUiLCJ0eXAiOiJKV1QifQ..ToV5d6BDrcecf5noZq32vc3ADH9R_xAo3hiMSNepPBEu72nDYUS5Rx14ijAU0a99XyiltJ8j0E-4Xc9XbELRswNlQrdHL-IWsQnxOpxxluToXBcWdcTyeFXlwmUPTScCYbSsuROAmW7DbX5kpEeSeCqJ_6GKXUBZDKf12To9iDvgjD-QSypWoky0IVmnvD8wygwilu8I_-sOqV091P92hP6eAQz_848FMC6yBE8CI4bRbKui_7IxGkhThaABhtll_3hyiOhdBXCBc_WSNBdCcuVrrU0l3axAY2iIKhivFQEfHKzm4jhhA6aayeLG09Rvv3yW37V4Ycm2CjksJXkbpA`
